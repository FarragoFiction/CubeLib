...
BABYLON.Vector2WithCallback = class extends BABYLON.Vector2 {
    ...
    set x(val) { super.x = val; this.extension_callback(this); }

    get y() { return super.y; }
    set y(val) { super.y = val; this.extension_callback(this); }

    addInPlace(otherVector) { super.addInPlace(otherVector); this.extension_callback(this); return this; }
    divideInPlace(otherVector) { super.divideInPlace(otherVector); this.extension_callback(this); return this; }
    multiplyInPlace(otherVector) { super.multiplyInPlace(otherVector); this.extension_callback(this); return this; }
    negateInPlace() { super.negateInPlace(); this.extension_callback(this); return this; }
    scaleInPlace(scale) { super.scaleInPlace(scale); this.extension_callback(this); return this; }
    subtractInPlace(otherVector) { super.subtractInPlace(otherVector); this.extension_callback(this); return this; }
